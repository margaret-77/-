...
<body>
	...
	<form action="station/update_allstation" method="post" name="form1">
		...
		终点站：<input  class="timeInput" type="text" name="end_sid" value="${end_sid}"> 
		<input  style="height: 30px; width:60px; font-size: 14px"
		...
		<div><br></div>
			...
			<tr>
			 ...
			 --%>
			  ...
			  <tr>
				<!-- <td class="button" colspan="16" style="height:100 %;width:100px; "><button class="button">批量修改</button> -->
